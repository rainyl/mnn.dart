...
mnn_expr_ReduceSum(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceMean(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceMax(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceMin(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceProd(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceAny(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
MNN_C_API mnn_expr_VARP_t
mnn_expr_ReduceAll(mnn_expr_VARP_t input_variable, VecI32 axis, bool keepDims);
...
MNN_C_API mnn_expr_VARP_t mnn_expr_RandomUniform(
...
MNN_C_API VecVARP *mnn_expr_Svd(mnn_expr_VARP_t x);
MNN_C_API mnn_expr_VARP_t
...
MNN_C_API mnn_expr_VARP_t mnn_expr_Concat(VecVARP values, int axis);
...
MNN_C_API mnn_expr_VARP_t mnn_expr_Stack(VecVARP values, int axis);
...
MNN_C_API VecVARP *mnn_expr_Moments(
...
MNN_C_API VecVARP *mnn_expr_Unstack(mnn_expr_VARP_t value, int axis);
...
MNN_C_API VecVARP *mnn_expr_TopKV2(mnn_expr_VARP_t input0, mnn_expr_VARP_t input1);
