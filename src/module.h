...
MNN_C_API void
mnn_runtime_manager_set_external_path(mnn_runtime_manager_t self, const char *external_path, int type);
MNN_C_API void
mnn_runtime_manager_set_external_file(mnn_runtime_manager_t self, const char *path);
...
MNN_C_API mnn_error_code_t mnn_module_on_forward(mnn_module_t self, VecVARP_t inputs, VecVARP_t *outputs, mnn_callback_0 callback);
MNN_C_API mnn_error_code_t mnn_module_forward(mnn_module_t self, VARP_t input, VARP_t *output, mnn_callback_0 callback);
