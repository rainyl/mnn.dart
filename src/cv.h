...
// structural.hpp
MNN_C_API VecVARP_t
mnn_cv_findContours(VARP_t image, int mode, int method, mnn_cv_point_t offset);
...
MNN_C_API mnn_cv_matrix_t mnn_cv_getAffineTransform(const mnn_cv_point_t src[], const mnn_cv_point_t dst[]);
MNN_C_API mnn_cv_matrix_t mnn_cv_getPerspectiveTransform(const mnn_cv_point_t src[], const mnn_cv_point_t dst[]);
